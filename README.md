...
>>>>>>> f5c7ddb09a286c25187b0deffb096f3bc73cca56
...
=======
__jsFunc__ - обрабатывает и собирает файлы javascript по пути __src/js__. (обрабатывает babel пользовательские скрипты, объеденяет со скриптами библиотек, создает полный и минифицированный файлы скриптов __scripts.js__ и __scripts.min.js__) (включает в себя задачи: __jsUseFunc__, __jsLibFunc__)
>>>>>>> f5c7ddb09a286c25187b0deffb096f3bc73cca56
